...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(
    scrollYProgress,
    [0, 0.35],
    hasTitle ? [1.2, isMobile ? 1 : 1.5] : [0.98, isMobile ? 1.16 : 1.24]
  );
  const scaleY = useTransform(
    scrollYProgress,
    [0, 0.35],
    hasTitle ? [0.6, isMobile ? 1 : 1.5] : [0.78, isMobile ? 1.04 : 1.12]
  );
  const translate = useTransform(scrollYProgress, [0, 0.35], hasTitle ? [0, 1500] : [18, -18]);
  const rotate = useTransform(scrollYProgress, [0, 0.16, 0.35], hasTitle ? [-28, -28, 0] : [-22, -18, -3]);
  ...
  return (
    <div
      ...
      className={cn(
        ...
        hasTitle ? 'min-h-[200vh] py-0 md:py-80' : 'min-h-[180vh] py-[4.5rem] md:py-0',
        className
      )}
    >
      {hasTitle && (
      ...
      <div
        className={cn('flex flex-col items-center', !hasTitle && 'sticky top-16 h-[calc(100vh-4rem)] justify-center')}
      >
        <div
          className={cn(
            'flex flex-col items-center scale-[0.6] [perspective:800px] sm:scale-[0.9] md:scale-[1.3]',
            hasTitle && 'scale-[0.35] sm:scale-50 md:scale-100',
            !hasTitle && 'translate-y-6'
          )}
        >
          {/* Lid */}
          <Lid
...
export const Lid = ({
  ...
  return (
    <div className='relative [perspective:800px]'>
      ...
      {expandedPreview && <div className='h-[17.7rem] w-[32rem]' aria-hidden='true' />}
      <motion.div
        style={{
          scaleX: scaleX,
          scaleY: scaleY,
        ...
        className={cn(
          'absolute inset-0 rounded-lg bg-[#050505] p-2 shadow-[0_18px_60px_rgba(0,0,0,0.45)] ring-1 ring-white/10',
          expandedPreview ? 'h-[17.7rem] w-[32rem]' : 'h-[18.25rem] w-[32rem]'
        )}
      >
        <img
          src={src as string}
