  ...
  return (
    <svg viewBox='0 0 200 160' className='w-full h-full'>
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x = roundCoordinate(100 + Math.cos(angle) * radius);
        const y = roundCoordinate(80 + Math.sin(angle) * radius);
...
function FeatureCard({ feature, index }: { feature: (typeof featureItems)[number]; index: number }) {
      ...
      <div className='max-w-[1400px] mx-auto px-6 lg:px-12'>
        ...
        <div className='mb-16 lg:mb-24'>
          ...
          >
            ...
            <br />
            <span className='text-muted-foreground'>under one desktop roof.</span>
          </h2>
        </div>
