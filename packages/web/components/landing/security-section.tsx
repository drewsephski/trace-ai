...
import { controlFeatures, controlPrinciples } from '@/lib/landing-content';

const icons = [Shield, FileCheck, Lock, Eye] as const;
        ...
        <div className='grid lg:grid-cols-2 gap-16 lg:gap-24'>
          ...
          >
            ...
            <p className='text-xl text-muted-foreground leading-relaxed mb-12'>
              Trace is designed around explicit user control. Agents can help with files, commands, tools, and
              automations, but the desktop app keeps approval and workspace boundaries visible.
            </p>

            {/* Certifications */}
            <div className='flex flex-wrap gap-3'>
              {controlPrinciples.map((cert, index) => (
                <span
                  key={cert}
