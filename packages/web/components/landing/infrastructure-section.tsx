        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Trace is a desktop app first. Hosted web surfaces, channels, and billing
              can exist around it, but core agent work does not require sending every
              project through a remote control plane.
            </p>
