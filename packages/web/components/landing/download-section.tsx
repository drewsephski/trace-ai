    ...
    <section id='download' className='relative py-32 lg:py-40 border-t border-foreground/10'>
      <div className='max-w-7xl mx-auto px-6 lg:px-12'>
        ...
        <div className='max-w-3xl mb-20'>
          <span className='font-mono text-xs tracking-widest text-muted-foreground uppercase block mb-6'>Download</span>
          ...
          <p className='text-lg text-muted-foreground max-w-xl'>
            Trace core usage is local-first and open source. Download the desktop app from GitHub Releases, or use the
            web package for hosted landing/account surfaces when the product needs them.
          </p>
        </div>
