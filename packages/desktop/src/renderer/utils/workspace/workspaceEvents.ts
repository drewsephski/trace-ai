export const WORKSPACE_TOGGLE_EVENT = 'trace-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'trace-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'trace-workspace-has-files';
