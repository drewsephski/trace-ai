...
const AionModal: React.FC<AionModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`trace-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='trace-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='trace-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
