...
export const PROTOCOL_SCHEME = 'trace';

/**
 * Parse a trace:// URL into action and params.
 * Supports two formats:
 *   1. trace://add-provider?base_url=xxx&api_key=xxx
 *   2. trace://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
