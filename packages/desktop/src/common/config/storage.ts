 ...
 * 会话来源类型 - 标识会话创建的来源
 */
export type ConversationSource = 'trace' | 'telegram' | 'lark' | 'dingtalk' | 'weixin' | 'wecom' | (string & {});
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 trace / Conversation source, defaults to trace */
...
export type TChatConversation =
  ...
  // AionCore/crates/trace-common/src/enums.rs and factory.rs.
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by Trace (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'trace-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['Trace Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
