 ...
 *   TRACE_DATA_DIR=/x bun run resetpass
 ...
 * desktop side). Callers can override with `--port` / `TRACE_PORT` to match
 ...
 * pass --port / TRACE_PORT if they launched webui on a non-default one.
 */
