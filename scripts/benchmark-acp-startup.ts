...
function getLogFilePath(): string {
  ...
  // Dev mode uses "Trace-Dev", production uses "Trace"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'Trace-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'Trace', `${today}.log`);
